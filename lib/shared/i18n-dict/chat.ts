...
export const chat = {
  ...
  "Codegraph and subagent capabilities": "提供代码图谱、子代理的能力",
  "Active": "已启用",
  "Inactive": "未启用",
  ...
  "Today's Sessions": "今日会话",
  "Refresh today's sessions": "刷新今日会话",
  "No sessions today": "今天还没有会话",
  "Toggle mode": "切换模式",
  "Close tab": "关闭标签页",

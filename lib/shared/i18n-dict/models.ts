...
export const models = {
  ...
  "Search model name...": "输入模型名称搜索目录...",
  "Type a model name to search the catalog": "输入模型名称以搜索模型目录",
  "↑↓ to navigate · Enter to select · Esc to cancel": "↑↓ 选择 · Enter 确认 · Esc 取消",
  "Skip and fill in manually": "跳过，手动填写",
  ...
  "Refresh models": "刷新模型",
  "Models refreshed": "模型列表已刷新",
  "Failed to refresh models": "刷新模型列表失败",
  "Fetch the latest model list for this provider": "从提供商在线获取最新模型列表",

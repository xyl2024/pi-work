...
export const ZH_TRANSLATIONS = {
  ...
  "Compact now?": "立即压缩上下文？",
  "Compact context": "压缩当前会话上下文",
  "Compact context?": "压缩当前会话上下文？",
  "Manually compact the conversation so the next prompt starts from a fresh, summarized context.": "手动压缩当前会话，下次 prompt 将从压缩后的摘要上下文继续。",
  "Optional focus (e.g. \"preserve React-specific details\"):": "可选：补充压缩重点（例如 \"保留 React 相关细节\"）：",
  "Wait for the current turn to end before compacting.": "请等待当前 turn 结束后再压缩。",
  "Compact failed": "压缩失败",
  "Compacted from {n} tokens": "已从 {n} tokens 压缩",
  "Context compacted": "上下文已压缩",
  "View summary": "查看摘要",
  "Compacted {n} tokens": "已压缩 {n} tokens",
  "Network error": "网络错误",
  "Copy failed": "复制失败",
  ...
  "sessions": "个会话",
  "+{n} more": "还有 {n} 条",
  // GrokBot companion (vendored from zhulin025/LaoA-GrokBot, MIT)
  "Pi Bot Lab": "Pi Bot 实验室",
  "Expression": "表情",
  "Randomize": "随机组合",
  "Random": "随机",
  "Auto tour": "自动巡演",
  ...
  "Body parts": "身体部件",
  "Accessories": "趣味配饰",
  "Open Pi Bot lab": "打开 Pi Bot 实验室",
  "Source repository": "原仓库",
  "Playing state {name}": "正在播放状态：{name}",
  "Click the bot to open the lab": "点击 Pi Bot 打开实验室",
